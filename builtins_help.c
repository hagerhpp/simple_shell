...
/**
 * help_all - a funx that displays all possible builtin shellby commands
 */
void help_all(void)
{
...
/**
 * help_alias - a funx that displays information on the shellby builtin
 * command 'alias'
 */
void help_alias(void)
{
...
/**
 * help_cd - a funx that displays information on the shellby builtin
 * command 'cd'
 */
void help_cd(void)
{
...
/**
 * help_exit - a funx that displays information on the shellby builtin
 * command 'exit'
 */
void help_exit(void)
{
...
/**
 * help_help - a funx that displays information on the shellby builtin
 * command 'help'
 */
void help_help(void)
{
